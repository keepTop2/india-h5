...
import RedbagRain from "/@/views/discount/activityType/RED_BAG_RAIN/rainPage.vue";
import Countdown from "/@/views/discount/activityType/RED_BAG_RAIN/countdownPgae.vue";
