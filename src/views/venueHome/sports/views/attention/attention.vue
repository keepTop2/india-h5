...
const EventCard = defineAsyncComponent(() => import("/@/views/Sports/views/attention/components/event/eventCard.vue"));
const OutRightCard = defineAsyncComponent(() => import("/@/views/Sports/views/attention/components/outRight/outRightItem.vue"));
