...
//自定义键盘图片
import numberKeyboard_delete from "/@/assets/zh-CN/default/venueHome/sports/numberKeyboard_delete.png";
import numberKeyboard from "/@/assets/zh-CN/default/venueHome/sports/numberKeyboard.png";
