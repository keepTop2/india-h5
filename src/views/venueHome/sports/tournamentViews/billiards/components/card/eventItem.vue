<template>
	...
	<div class="content">
		...
		<div class="content-header">
			...
			<!-- 盘口表头  -->
			<div class="right">
				<div class="title">{{ SportsCommonFn.betTypeMap[7][20] }}</div>
				<div class="title">{{ SportsCommonFn.betTypeMap[7][1] }}</div>
				<div class="title">{{ SportsCommonFn.betTypeMap[7][3] }}</div>
			</div>
		</div>
		<!-- 内容区域 主体 -->
...
// 	const parentId = safeAccess(props.event, ["parentId"]);
...
// 		} else {
// 			return `第${common.getInstance().add(gameInfo.liveHomeScore, gameInfo.liveAwayScore) + 1}局`;
// 		}
// 	}
// 	return convertUtcToUtc5AndFormatMD(globalShowTime);
// });
