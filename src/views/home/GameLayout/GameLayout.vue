	...
	<div class="container bg_BG3">
		<div class="left-section">
			<div class="item big" id="item-1" @click="Common.goToGame(gameInfoList?.[0])">
				...
				<VantLazyImg :src="gameInfoList?.[0]?.iconFileUrl" />
				<!-- <NoGameImg v-else /> -->
			</div>
			<div class="small-items">
				<div class="item" id="item-5" @click="Common.goToGame(gameInfoList?.[4])">
					...
					<VantLazyImg :src="gameInfoList?.[4]?.iconFileUrl" />
				</div>
				<div class="item" id="item-6" @click="Common.goToGame(gameInfoList?.[5])">
					...
					<VantLazyImg :src="gameInfoList?.[5]?.iconFileUrl" />
				</div>
			</div>
		</div>
		<div class="right-section">
			<div class="small-items">
				<div class="item" id="item-3" @click="Common.goToGame(gameInfoList?.[2])">
					...
					<VantLazyImg :src="gameInfoList?.[2]?.iconFileUrl" />
				</div>
				<div class="item" id="item-4" @click="Common.goToGame(gameInfoList?.[3])">
					...
					<VantLazyImg :src="gameInfoList?.[3]?.iconFileUrl" />
				</div>
			</div>
			<div class="item big" id="item-2" @click="Common.goToGame(gameInfoList?.[1])">
				...
				<VantLazyImg :src="gameInfoList?.[1]?.iconFileUrl" />
			</div>
		</div>
	</div>
</template>
