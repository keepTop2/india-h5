<template>
	<div class="container bg_BG3">
		...
		<div class="match-info mb_24">
			...
			<div v-if="!SportsCommonFn.isStartMatch(event)" class="score color_TB bg_BG4">{{ event.gameInfo?.liveHomeScore }}</div>
		</div>
		<div class="match-info">
			...
			<div v-if="!SportsCommonFn.isStartMatch(event)" class="score color_TB bg_BG4">{{ event.gameInfo?.liveAwayScore }}</div>
		</div>
