<template>
	...
	<div class="odds">
		<div class="odds-item" @click="onSetSportsEventData(market?.selections[0])">
		...
		<div class="odds-item" v-show="sportType == 1" @click="onSetSportsEventData(market?.selections[1])">
		...
		<div class="odds-item" @click="onSetSportsEventData(market?.selections[2])">
